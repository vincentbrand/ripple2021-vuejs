  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow mx-1" style="font-size: 14px">
							...
							<div class="menu-color dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="lang">
								<span class="menu-color dropdown-item" href="#" @click="tabZH">
									中文
								</span>
								<span class="menu-color dropdown-item" href="#" @click="tabEN">
									English
								</span>								
						...
						<li class="nav-item dropdown no-arrow">
							...
							<div class="menu-color dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
								...
								<a class="dropdown-item" href="#">
									<i class="fas fa-file-invoice-dollar fa-sm fa-fw mr-2 text-gray-400"></i> Invoices
								</a>
